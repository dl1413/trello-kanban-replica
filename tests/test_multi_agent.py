...
class TestMultiAgentBaseEnvironment:
    ...
    def test_initialization_with_config(self):
        ...
        config = {"num_agents": 4, "reward_mode": "competitive", "collision_mode": "pass-through"}
...
class TestMultiAgentGridWorld:
    ...
    def test_initialization(self):
        ...
        config = {"num_agents": 2, "grid_size": 5, "reward_mode": "cooperative"}
    ...
    def test_cooperative_mode_goals(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 10, "reward_mode": "cooperative"})
        obs, info = env.reset(seed=42)
    ...
    def test_competitive_mode_goals(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 10, "reward_mode": "competitive"})
        obs, info = env.reset(seed=42)
    ...
    def test_collision_block_mode(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 5, "collision_mode": "block"})
    ...
    def test_collision_pass_through_mode(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 5, "collision_mode": "pass-through"})
        obs, info = env.reset(seed=42)
    ...
    def test_collision_penalty_mode(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 5, "collision_mode": "penalty"})
        obs, info = env.reset(seed=42)
    ...
    def test_goal_reaching_reward(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 1, "grid_size": 5, "reward_mode": "cooperative"})
        obs, info = env.reset(seed=42)
    ...
    def test_cooperative_termination(self):
        ...
        env = MultiAgentGridWorld(
            {"num_agents": 2, "grid_size": 10, "reward_mode": "cooperative", "episode_length": 100}
        )
        obs, info = env.reset(seed=42)
    ...
    def test_competitive_termination(self):
        ...
        env = MultiAgentGridWorld(
            {"num_agents": 2, "grid_size": 5, "reward_mode": "competitive", "episode_length": 100}
        )
        obs, info = env.reset(seed=42)
    ...
    def test_episode_length_truncation(self):
        ...
        env = MultiAgentGridWorld({"num_agents": 2, "grid_size": 5, "episode_length": 5})
        env.reset()
